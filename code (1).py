...
df1 = pd.read_csv('input/AEP_hourly.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('input/COMED_hourly.csv', delimiter=',', nrows = nRowsRead)
